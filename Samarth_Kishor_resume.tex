...
{Produced internal IT security and information systems documentation and policies. Took on additional roles including refactoring and setting up an automated build and test pipeline for an internal web application and improving the Impact Makers WordPress website.}
...
{JavaScript\ \ $\cdotp$\ \ Python\ \ $\cdotp$\ \ Java\ \ $\cdotp$\ \ Lean\ \ $\cdotp$\ \ Emacs Lisp}
