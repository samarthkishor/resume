...
\item \textbf{Relevant Coursework:} Software Development Methods\ \ $\cdotp$\ \ Program and Data Representation\ \ $\cdotp$\ \ Algorithms\ \ $\cdotp$\ \ Theory of Computation\ \ $\cdotp$\ \ Data Visualization\ \ $\cdotp$\ \ Linear Algebra
\end{itemize}
...
{Git\ \ $\cdotp$\ \ Shell scripting\ \ $\cdotp$\ \ React Native\ \ $\cdotp$\ \ GNU/Linux \& Unix\ \ $\cdotp$\ \ Vim \& Emacs}
