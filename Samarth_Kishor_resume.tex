...
{Teaching Assistant for CS 2102 (Discrete Math). Helped students in office hours and graded assignments.}

\workSubheading{Impact Makers Inc.}{Richmond, VA}
{Junior Security Associate}{Summer 2018}
{Produced internal IT security documentation and policies for the company intranet hosted on Microsoft Azure. Took on additional roles including refactoring and setting up an automated build and test pipeline for an internal AWS web application and improving the Impact Makers WordPress website.}
...
{Python\ \ $\cdotp$\ \ JavaScript\ \ $\cdotp$\ \ Java\ \ $\cdotp$\ \ C++\ \ $\cdotp$\ \ Emacs Lisp}
